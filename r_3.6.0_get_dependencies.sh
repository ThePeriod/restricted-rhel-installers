...
wget http://52.33.4.66/hdp_utils/centos/7/openblas/openblas-devel-0.2.19-4.el7.x86_64.rpm
wget https://koji.xcp-ng.org/kojifiles/packages/pango/1.40.4/1.el7/x86_64/pango-1.40.4-1.el7.x86_64.rpm --no-check-certificate
...
wget https://koji.xcp-ng.org/kojifiles/packages/unzip/6.0/19.el7/x86_64/unzip-6.0-19.el7.x86_64.rpm --no-check-certificate
